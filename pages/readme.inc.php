   ...
   <div class="rex-addon-output">
      ...
      <div class="rex-addon-content">
         ...
         <?php
            ...
            echo $I18N->msg($page.'_subpage_readme_txt_01_09') . "<br />";
            echo $I18N->msg($page.'_subpage_readme_txt_01_10') . "<br />";
            echo $I18N->msg($page.'_subpage_readme_txt_01_11') . "<br />";
            echo $I18N->msg($page.'_subpage_readme_txt_01_12') . "<br />";
            echo $I18N->msg($page.'_subpage_readme_txt_01_13') . "<br />";
         ?>
         </span></code>
         </p>
      </div>
